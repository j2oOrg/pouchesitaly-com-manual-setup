...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    freeShippingLong: 'Every order ships free across Italy. Plain packaging for complete privacy.',
  ...
  it: {
    ...
    freeShippingLong: 'Ogni ordine viene spedito gratuitamente in tutta Italia. Imballaggio anonimo per la massima privacy.',
    ...
    shopNowCta: 'Acquista ora e goditi la spedizione gratuita in tutta Italia',

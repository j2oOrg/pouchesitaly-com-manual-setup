...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    heroDesc: 'Discover our curated selection of top brands. Fast, discreet shipping straight to your door, with unbeatable prices.',
  ...
  it: {
    ...
    support: 'Supporto',
    delivery: 'Consegna',
    elevateExperience: 'Migliora la Tua Esperienza',
    heroDesc: 'Scopri la nostra selezione curata dei migliori marchi. Spedizione veloce e discreta direttamente a casa tua, a prezzi imbattibili.',
